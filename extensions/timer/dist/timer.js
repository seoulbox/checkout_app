...
${errorInfo.componentStack}`);
  ...
  var checkoutBlock = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {}));
  function Extension() {
    const countdownTime = 8;
    const initialTime = countdownTime * 60;
    const [timeRemaining, setTimeRemaining] = (0, import_react12.useState)(initialTime);
    const [isTimeUp, setIsTimeUp] = (0, import_react12.useState)(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: !isTimeUp && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: "base", border: "base", borderWidth: "base", borderRadius: "loose", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Grid2, { spacing: "base", columns: ["5%", "auto"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { inlineAlignment: "center", Alignment: "center", source: "https://cdn.shopify.com/s/files/1/0550/5164/9153/files/clock.png?v=1699958461" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { size: "large", children: [
        "Hurry! Your orders will be reversed in ",
        minutes,
        "m ",
        seconds,
        "s"
